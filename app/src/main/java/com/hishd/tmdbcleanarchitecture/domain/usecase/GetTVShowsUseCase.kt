...
class GetTVShowsUseCase(private val tvShowRepository: TVShowRepository) : BaseUseCase<TVShow> {
    override suspend fun execute(): List<TVShow>? = tvShowRepository.getTVShows()
}